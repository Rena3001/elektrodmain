                    ...
                    <div class="tab-pane fade {{ $key === 0 ? 'show active' : '' }}" id="{{ 'language_line' . $lang->code }}" role="tabpanel" aria-labelledby="custom-tabs-four-home-tab">
                        <div class="card-body">
                            <div class="form-group">
                                <label for="text_{{ $lang->code }}">Text</label>
                                <input type="text" class="form-control @error('text.' . $lang->code) is-invalid @enderror" id="text_{{ $lang->code }}" name="text[{{ $lang->code }}]" value="{{ old('text.' . $lang->code) }}">
