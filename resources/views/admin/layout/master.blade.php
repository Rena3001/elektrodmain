        ...
        <nav class="navbar navbar-top navbar-slim fixed-top navbar-expand" id="topNavSlim" style="display:none;">
            <div class="collapse navbar-collapse justify-content-between">
                <div class="navbar-logo">
                    ...
                    <a class="navbar-brand navbar-brand" href="index-1.html">phoenix <span
                ...
                <ul class="navbar-nav navbar-nav-top" data-dropdown-on-hover="data-dropdown-on-hover">
                    <li class="nav-item dropdown"><a class="nav-link dropdown-toggle lh-1" href="#!"
                        ...
                        <ul class="dropdown-menu navbar-dropdown-caret">
                            <li><a class="dropdown-item active" href="index-1.html">
                            ...
                            <li class="dropdown"><a class="dropdown-item dropdown-toggle" id="travel-agency"
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a class="dropdown-item nav-link-disable" href="coming-soon.html">
                                            <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Flight
                                            </div>
                                        </a></li>
                                    <li><a class="dropdown-item nav-link-disable" href="coming-soon.html">
                            ...
                            <ul class="dropdown-menu navbar-dropdown-caret">
                                ...
                                <li class="dropdown"><a class="dropdown-item dropdown-toggle" id="travel-agency"
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li><a class="dropdown-item nav-link-disable" href="coming-soon.html">
                                                <div class="dropdown-item-wrapper"><span
                                                        class="me-2 uil"></span>Flight</div>
                                            </a></li>
                                        <li><a class="dropdown-item nav-link-disable" href="coming-soon.html">
                                                <div class="dropdown-item-wrapper"><span
                                                        class="me-2 uil"></span>Trip</div>
                                            </a></li>
                                    </ul>
                                </li>
                                <li><a class="dropdown-item" href="apps/chat.html">
