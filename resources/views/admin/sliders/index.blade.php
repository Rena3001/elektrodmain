...
<div class="card mb-3">
    <div class="card-header p-4 border-bottom bg-body">
        <a class="btn btn-sm btn-phoenix-success" href="{{route('admin.sliders.create')}}" role="button"
                                    ...
                                    <div class="btn-reveal-trigger position-static">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end py-2">
                                            <a class="dropdown-item"
                                                href="{{ route('admin.sliders.show', $slider->id) }}"><span
                                                    data-feather="info"></span></a>
                                            <a class="dropdown-item"
                                                href="{{ route('admin.sliders.edit', $slider->id) }}"><span
