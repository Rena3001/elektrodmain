    ...
    <div class="card">
        <div class="card-header p-4 border-bottom bg-body">
            <a class="btn btn-sm btn-phoenix-primary"
                href="{{route('admin.valve_categories.create')}}" role="button" aria-controls="basic-example-code" >  Create</a>
        </div>
        <div class="card-body">
                        ...
                        <table class="table table-striped table-sm fs-9 mb-0">
                            <thead>
                                <tr>
                                    ...
                                    <th class="sort border-top" data-sort="email">Slug</th>
                                        ...
                                        <td class="align-middle">
                                            ...
                                            @if (is_array($titles))
                                                @foreach ($titles as $lang => $title)
                                                    <p><strong>{{ strtoupper($lang) }}:</strong> {{ $title }}</p>
                                                @endforeach
                                            @else
                                                <p>{{ $model->title }}</p>
                                            @endif
                                            ...
                                            <div class="btn-reveal-trigger position-static">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end py-2">
                                                    <a class="dropdown-item"
                                                        href="{{ route('admin.valve_categories.show', $model->id) }}">View</a>
                                                    <a class="dropdown-item"
                                                        href="{{ route('admin.valve_categories.edit', $model->id) }}">Edit</a>
                                                    <div class="dropdown-divider"></div>
                                                    {{-- <a class="dropdown-item text-danger"
                                                        href="{{ route('admin.valve_categories.destroy', $model->id) }}"
